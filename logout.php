...
<div class="row">
  ...
  <div class="col-sm-12 forgot text-center">

  <div class="form form_clientid">
  ...
  <h1 style="font-size: 35px; margin-top: 20px;">YOU HAVE BEEN LOGGED OUT SUCCESSFULLY!<br></h1>


    <button class="button button-block"><a href="user_login.php" class="reset_link">HOME</a></button>
  </div>
